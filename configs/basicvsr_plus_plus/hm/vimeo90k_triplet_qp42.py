_base_ = ["../../_base_/runtime.py", "../../_base_/hm/vimeo90k_triplet_qp42.py"]

exp_name = "basicvsr_plus_plus_vimeo90k_triplet_qp42"
...
data = dict(
    train=dict(dataset=dict(padding=False, center_gt=center_gt)),
